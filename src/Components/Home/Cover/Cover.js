...
const Cover = () => {
    ...
    const { text } = useTypewriter({
        words: ['Fontend Developer', 'Full Stack Developer', 'Mern Stack Developer'],
        loop: {},
        cursor: '',
    ...
    return (
        <>
            <section className="top d-lg-flex col-lg-12 col-md-12 d-sm-block text-lg-start text-sm-start bg-dark pb-3 ">
